...
import { getMagicLinkMessages } from './messages/index.ts';
...
export function MagicLink({ signInUrl, locale }: MagicLinkProps) {
  const m = getMagicLinkMessages(locale);
...
MagicLink.PreviewProps = {
  signInUrl: 'https://earthropy.org/en/signin/magic/example-token',
  locale: 'en',
