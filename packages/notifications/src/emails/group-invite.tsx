...
import { getGroupInviteMessages } from './messages/index.ts';
...
export function GroupInvite({ inviteUrl, groupName, inviterName, locale }: GroupInviteProps) {
  const m = getGroupInviteMessages(locale);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {inviterName} has invited you to join <strong>{groupName}</strong>.
            </Text>
...
GroupInvite.PreviewProps = {
  inviteUrl: 'https://earthropy.org/en/invite/example-token',
